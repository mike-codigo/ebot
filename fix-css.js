...
// The mistake was injecting JS template string directly into the JS body instead of inside style.innerHTML
// Let's restore the file first.
content = content.replace(/\.chat-section \{[\s\S]*?z-index: 2;\s*\}/, '');
...
content = content.replace('`;\n    document.head.appendChild(style);', correctInjection);
